 ...
 class A {
	...
	*/
	...
	void run()throws Exception{
 	 	long a[] = new long[10];
 	 	a[1] = -1;a[2] = 3; a[3] = 3; a[4] = 3; a[5] = 5; a[6] =5; a[7] = 9;a[8] = 9;a[9] = 9;
  		out.write(""+lower_bound(a,-5)+"\n");
  		out.write(""+lower_bound(a,-1)+"\n");
  		out.write(""+lower_bound(a,1)+"\n");
  		out.write(""+lower_bound(a,3)+"\n");
  		out.write(""+lower_bound(a,4)+"\n");
  		out.write(""+lower_bound(a,5)+"\n");
  		out.write(""+lower_bound(a,8)+"\n");
  		out.write(""+lower_bound(a,9)+"\n");
  		out.write(""+lower_bound(a,10)+"\n");
  		out.write("upper\n");
  		out.write(""+upper_bound(a,-5)+"\n");
  		out.write(""+upper_bound(a,-1)+"\n");
  		out.write(""+upper_bound(a,1)+"\n");
  		out.write(""+upper_bound(a,3)+"\n");
  		out.write(""+upper_bound(a,4)+"\n");
  		out.write(""+upper_bound(a,5)+"\n");
  		out.write(""+upper_bound(a,8)+"\n");
  		out.write(""+upper_bound(a,9)+"\n");
  		out.write(""+upper_bound(a,10)+"\n");
