...
public class TopologicalOrder{
	...
	*/
	...
	final int MAXV = 6;//critical
	int v = 0;
	boolean vis [] = new boolean [MAXV+1];
	int order[] = new int [MAXV + 1];
	LinkedList<Integer> adj[] = new LinkedList[MAXV+1];
	...
	void clear(){
	  ...
	  for (int i = 1; i <= v; i++){
        ...
        while (!stack.empty())order[idx++] = (int)stack.pop();
	...
	void printOrder(){
		for(int i = 1 ; i<= v ; i++)out.write(""+order[i]+" ");
	}
//****************************** My Utilities ***********************//
