 ...
 * Algorithm : Extended Euclid Algo: find 3 things X, Y, GCD(BiTSet, B) Such that X * BiTSet + Y * B = GCD(BiTSet, B)
 *             Time : O(MAX(BiTSet, B)) Space : O(MAX(BiTSet, B))
 * Platform  : Codeforces
...
class SolutionMain{
  ...
  public SolutionMain(){}
  public SolutionMain(boolean stdIO)throws FileNotFoundException{
    // stdIO = false;
    if(stdIO){
...
//  val = ((long)(val * 100.0))/100.0;    
  ...
  public static void main(String[] args) throws java.lang.Exception{
    ...
    SolutionMain driver = new SolutionMain(true);
    driver.run();
